        ...
        <nav className="w-full p-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              {user ? (
                <div
                  className={`group flex justify-start items-center gap-4 cursor-pointer border border-[rgb(255,156,72,1)] rounded-lg w-36 h-12 py-2 pl-6 relative bg-[rgb(255,156,72,1)] text-white text-[16px] font-semibold ${
                    profileDropdown ? "" : "hover:bg-orange-400 "
                  }`}
                  onClick={() => setProfileDropdown((prev) => !prev)}
                >
                  <BiSolidUserAccount size={21} />
