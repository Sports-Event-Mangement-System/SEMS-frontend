  ...
  const cardData = [
    {
      ...
      value: dashboardData?.total_tournaments || 0,
      icon: <FaTrophy size={24} color="#e97026" />,
      color: "bg-red-100",
    },
    {
      title: "TOTAL TEAM",
      value: dashboardData?.total_teams || 0,
      icon: <HiUserGroup size={24} color="#e97026" />,
      color: "bg-blue-100",
    },
    {
      title: "TOTAL PLAYER",
      value: dashboardData?.total_players || 0,
      icon: <IoMdMan size={24} color="#e97026" />,
      color: "bg-teal-100",
    },
    {
      title: "ACTIVE TOURNAMENT",
      value: dashboardData?.active_tournaments || 0,
      icon: <FaTrophy size={24} color="#e97026" />,
      color: "bg-orange-100",
    },
    {
      title: "ACTIVE TEAM",
      value: dashboardData?.active_teams || 0,
      icon: <HiUserGroup size={24} color="#e97026" />,
      color: "bg-purple-100",
    },
    {
      title: "ONGOING TOURNAMENT",
      value: dashboardData?.ongoing_tournaments || 0,
      icon: <FaTrophy size={24} color="#e97026" />,
      color: "bg-yellow-100",
    },
    {
      title: "COMPLETED TOURNAMENT",
      value: dashboardData?.completed_tournaments || 0,
      icon: <FaTrophy size={24} color="#e97026" />,
      color: "bg-green-100",
    },
  ];
    ...
    <div className="flex flex-col flex-1 h-screen">
      ...
      <div className="m-4">
            ...
            <Card key={index} background={card.color}>
              <div className="m-6">
                ...
                <div className="flex gap-8 items-center">
                  <div className="p-2 h-fit w-fit rounded-md bg-[#dcdcdc]">
                    {card.icon}
                  </div>
        ...
        <div className="mt-10 p-4 bg-white rounded-lg shadow-md">
          <h1 className="text-2xl font-bold text-[#0ab39c] flex items-center gap-2">
